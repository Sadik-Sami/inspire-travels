...
const Signup = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const result = await signup(formData.name, formData.email, formData.phone, formData.password, formData.address);
	...
	const handleGoogleSignup = async () => {
		...
		try {
			...
			if (result.success) {
				...
				setSignupError(result.error || 'Failed to sign up with Google');
			}
		} catch (error) {
			setSignupError('An unexpected error occurred. Please try again.');
